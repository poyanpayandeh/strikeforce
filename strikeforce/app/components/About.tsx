  ...
  return (
    <section className='max-w-screen-sm'>
      <div className='flex flex-col justify-center items-center gap-2 text-center'>
        <h1 className='font-bold font-serif text-4xl md:text-6xl text-nowrap'>Home</h1>
        <h1 className='font-bold font-serif text-4xl md:text-6xl text-nowrap'>of</h1>
        <h1 className='font-bold font-serif text-4xl md:text-6xl text-nowrap'>Champions!</h1>
